...
export function DrawerWithNav(props) {
  ...
  /**
   *  setAllRoomIds description: get all roomIds from db and set in allRoomIds state
  */ 
  React.useEffect(() => {
    if (user?.uid) {
  ...
  /* 
    setUsers description: get all users from db and set in allUsers state
 */
